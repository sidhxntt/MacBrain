...
- [x] **Step 1: Write failing parameterized planner tests**
...
- [x] **Step 3: Add plan types and composable normalization**
...
- [x] **Step 4: Keep compatibility routing as a derived adapter**
...
- [x] **Step 1: Write failing count/order/date tests**
...
- [x] **Step 3: Implement bounded typed database queries**
...
- [x] **Step 1: Write direct-answer tests**
...
- [x] **Step 1: Reproduce general-route bypass and semantic-timeout loss**
...
- [x] **Step 3: Split retrieval into mandatory lexical and optional enrichment**
...
- [x] **Step 1: Write one terminal-path test per plan**
...
- [x] **Step 3: Execute a single plan once**
...
- [x] **Step 1: Write supported-domain and unsupported-maximum tests**
...
- [x] **Step 3: Extend typed facts and collection**
...
- [x] **Step 4: Implement deterministic and synthesis responses**
...
- [x] **Step 1: Write failing revision/access/dynamic tests**
...
- [x] **Step 3: Derive cacheability from the plan**
...
- [x] **Step 1: Run focused query tests**
...
- [x] **Step 2: Run connector adversarial and full deterministic suites**
...
- [x] **Step 3: Keep the manual artifact questions-only**
