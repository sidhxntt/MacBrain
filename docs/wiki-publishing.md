# Publishing the NotchBrain GitHub Wiki
...
2. Clone `https://github.com/sidhxntt/NotchBrain.wiki.git` beside this repository. If that clone endpoint has not been initialized yet, create the first Wiki page once in GitHub’s web UI, then clone it.
